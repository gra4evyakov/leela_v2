...
const cellClick = (item : Number) => {
    ...
    else if (isMovingTwo.value) {
        currentCellTwo.value = item
        if (gameMode.value) {
            gameModeRules(item)
        }
        isMovingTwo.value = !isMovingTwo.value
                ...
                <div class="cells-row" v-for="row in cells">
                    <div
                        ...
                        <div
                            ...
                            class="chip"
                            :class="{'chip-active' : isMoving, 'small-chip-left': currentCell == currentCellTwo}"
                            :style="{
                        ...
                        <div
                            ...
                            class="chip"
                            :class="{'chip-active' : isMovingTwo, 'small-chip-right': currentCell == currentCellTwo}"
                            :style="{
